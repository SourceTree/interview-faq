...
create table category (id bigint not null auto_increment, created_date datetime not null, deleted bit, modified_date datetime, version integer, categoryDescription varchar(500) not null, name varchar(80) not null unique,displayname varchar(80) not null unique, primary key (id)) ENGINE=InnoDB;
