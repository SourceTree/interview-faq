...
create table category (id bigint not null auto_increment, created_date datetime, deleted bit, modified_date datetime, version integer, categoryDescription varchar(500), name varchar(80), primary key (id)) ENGINE=InnoDB;
