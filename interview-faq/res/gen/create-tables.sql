...
create table category (id bigint not null auto_increment, created_date datetime not null, deleted bit, modified_date datetime, version integer, categoryDescription varchar(500) not null, name varchar(80) not null unique, primary key (id)) ENGINE=InnoDB;
create table question (id bigint not null auto_increment, created_date datetime not null, deleted bit, modified_date datetime, version integer, answer varchar(5000) not null, question varchar(200) not null, primary key (id)) ENGINE=InnoDB;
create table user (id bigint not null auto_increment, created_date datetime not null, deleted bit, modified_date datetime, version integer, email varchar(255) not null unique, name varchar(80), password varchar(150) not null, role varchar(30) not null, primary key (id)) ENGINE=InnoDB;
