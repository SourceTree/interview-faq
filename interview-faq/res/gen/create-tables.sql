...
create table user (id bigint not null auto_increment, created_date datetime, deleted bit, modified_date datetime, version integer, email varchar(255), name varchar(80), password varchar(150), role varchar(30), primary key (id)) ENGINE=InnoDB;
